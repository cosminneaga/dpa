    ...
    <user-layout>
        ...
        <v-container style="max-width: 1000px" v-else>
            <v-container class="d-flex flex-wrap" style="gap: 10px">
                <v-btn color="primary" @click="goToEdit" class="mt-4" variant="outlined">Edit this blog</v-btn>

                <v-btn color="red" @click="handleDelete" class="mt-4" variant="outlined">delete this blog</v-btn>
            </v-container>
            ...
            <v-container class="d-flex py-1 px-0" style="gap: 5px">
                <v-chip v-for="(item, i) in blog.tags" :key="i" label color="primary">{{ item }}</v-chip>
            </v-container>
