        ...
        >
            ...
            <v-form class="ma-4">
                ...
                <section class="my-3">
                    ...
                    <v-btn @click="addAuthorLink" color="primary" variant="outlined"
                        >Add Link</v-btn
                    >
                </section>
                <!-- AUTHOR LINKS -->
                ...
                <section class="mt-3 mb-5">
                    <v-row class="pa-5" style="gap: 10px">
                        ...
                        >
                            {{ item }}
                            <v-icon color="purple" @click="removeTag(i)" class="ml-2"
                                >mdi-close-octagon</v-icon
                            >
                        </v-chip>
                    </v-row>
                    ...
                    <v-btn @click="addTag" color="primary" variant="outlined"
                        >Add Tag</v-btn
                    >
                </section>
                <!-- TAGS -->
    ...
    methods: {
        async handleSubmit() {
            try {
                ...
                this.toast.success(
                    `Blog ${this.$props.update ? "updated" : "created"} successfully.`,
                );
            } catch (e: any) {
