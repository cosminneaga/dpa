<template>
  <section>
    ...
    >
      ...
      <v-form class="ma-4">
        ...
        <section class="my-3 px-3">
          ...
          <section class="mt-3">
            <v-row style="gap: 5px">
              <v-text-field variant="outlined" density="compact" label="Alt" v-model="blog.image.alt"></v-text-field>
              <v-text-field
                variant="outlined"
                density="compact"
                label="Title"
              ...
              ></v-text-field>
              <v-text-field variant="outlined" density="compact" label="Src" v-model="blog.image.src"></v-text-field>
            </v-row>
          </section>
        </section>
          ...
          <section class="my-3">
            <v-row class="pa-5" style="gap: 10px">
              ...
              >
                ...
                <v-icon color="primary" @click="removeAuthorLink(i)" class="ml-2">mdi-close-octagon</v-icon>
              </v-chip>
            </v-row>
          </section>

          <v-row style="gap: 5px" class="px-3">
            <v-text-field label="Text" density="compact" variant="outlined" v-model="authorLink.text"></v-text-field>
            <v-text-field label="Url" density="compact" variant="outlined" v-model="authorLink.url"></v-text-field>
            <v-text-field
              label="Image src"
              density="compact"
              variant="outlined"
        ...
        <section class="mt-3 mb-5">
          ...
          <v-text-field label="Tag" density="comfortable" variant="outlined" v-model="tag"></v-text-field>
    ...
    <v-container fluid>
      ...
      <kothing-editor @on-change="(content) => onContentChange(content)" :contentSet="update ? update.content : null" />
    </v-container>
    <!-- WYSIWYG EDITOR -->
  </section>
</template>
